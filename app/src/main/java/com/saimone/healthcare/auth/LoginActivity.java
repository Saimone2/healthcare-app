package com.saimone.healthcare.auth;
            ...
            try(Database db = new Database(getApplicationContext(), "healthcare", null, 1)) {
                if (username.length() == 0 || password.length() == 0) {
                    ...
                    if (db.login(username, password) == 1) {
                        ...
                        Intent intent = username.equals("admin") ? new Intent(LoginActivity.this, AdminPanelActivity.class) : new Intent(LoginActivity.this, HomeActivity.class);
